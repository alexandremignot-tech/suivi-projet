...
// Connexion automatique sans identifiants, pour un usage simple/solo pendant les tests.
// Actif uniquement si AUTO_LOGIN=true. A desactiver (AUTO_LOGIN=false) avant toute mise en ligne
// publique : sans cela, n'importe qui connaissant l'URL a un acces complet sans mot de passe.
router.get(
  "/dev-session",
  asyncHandler(async (req, res) => {
